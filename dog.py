...
class Ui_MainWindow5(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/Food/dog_food.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("images/Footprints/Dog_foot1.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_1.setIcon(icon1)
        self.pushButton_1.setIconSize(QtCore.QSize(270, 300))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("images/Soundpic/Dog__soundpic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
